...
# 	1. Ställer in tangentbordsgenvägar (för gnome)
#	2. Installerar en handfull program
#	3. Skapar och populerar en alias-fil
#	4. Konfigurerar program och generella inställningar
...
function gnome_keybindings() {
	...
	gsettings set org.gnome.shell.extensions.pop-shell pop-monitor-right \
		"['<Shift><Super>Right', '<Shift><Super>KP_Right', '<Shift><Super>l', '<Primary><Super>d']"

	gsettings set org.gnome.shell.extensions.pop-shell pop-monitor-left \
		"['<Shift><Super>Left', '<Shift><Super>KP_Left', '<Shift><Super>h', '<Primary><Super>a']"

	gsettings set org.gnome.shell.extensions.pop-shell pop-monitor-up \
		"['<Primary><Shift><Super>Up', '<Primary><Shift><Super>KP_Up', '<Primary><Shift><Super>k', '<Primary><Super>w']"

	gsettings set org.gnome.shell.extensions.pop-shell pop-monitor-down \
		"['<Primary><Shift><Super>Down', '<Primary><Shift><Super>KP_Down', '<Primary><Shift><Super>j', '<Primary><Super>s']"
	...
	gsettings set org.gnome.shell.extensions.pop-shell pop-workspace-down \
		"['<Shift><Super>Down', '<Shift><Super>KP_Down', '<Shift><Super>j', '<Shift><Super>s']"

	gsettings set org.gnome.shell.extensions.pop-shell pop-workspace-up \
		"['<Shift><Super>Up', '<Shift><Super>KP_Up', '<Shift><Super>k', '<Shift><Super>w']"

	gsettings set org.gnome.desktop.wm.keybindings move-to-workspace-last \
		"['<Shift><Super>End', '<Shift><Super>greater', '<Shift><Super>greater']"

	## KEYBINDINGS: Flytta fokus mellan fönster
	gsettings set org.gnome.shell.extensions.pop-shell focus-down \
		"['<Super>Down', '<Super>KP_Down', '<Super>j', '<Alt><Super>s', '<Alt><Super>Down']"

	gsettings set org.gnome.shell.extensions.pop-shell focus-up \
		"['<Super>Up', '<Super>KP_Up', '<Super>k', '<Alt><Super>w', '<Alt><Super>Up']"

	gsettings set org.gnome.shell.extensions.pop-shell focus-left \
		"['<Super>Left', '<Super>KP_Left', '<Super>h', '<Alt><Super>a', '<Alt><Super>Left']"

	gsettings set org.gnome.shell.extensions.pop-shell focus-right \
		"['<Super>Right', '<Super>KP_Right', '<Super>l', '<Alt><Super>d', '<Alt><Super>Right']"
